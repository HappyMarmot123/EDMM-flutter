...
abstract class AudioPlayerPlatform {
  ...
  /// Gets the Darwin equalizer parameters.
  Future<DarwinEqualizerGetParametersResponse> darwinEqualizerGetParameters(
      DarwinEqualizerGetParametersRequest request) {
    throw UnimplementedError(
        "darwinEqualizerGetParameters() has not been implemented.");
  }

  /// Sets the gain for a Darwin equalizer band.
...
/// Information communicated to the platform implementation when requesting the
/// Darwin equalizer parameters.
class DarwinEqualizerGetParametersRequest {
  DarwinEqualizerGetParametersRequest();

  Map<dynamic, dynamic> toMap() => <dynamic, dynamic>{};
}

/// Information communicated to the platform implementation after requesting
/// the Darwin equalizer parameters.
class DarwinEqualizerGetParametersResponse {
  final DarwinEqualizerParametersMessage parameters;

  DarwinEqualizerGetParametersResponse({required this.parameters});

  static DarwinEqualizerGetParametersResponse fromMap(
          Map<dynamic, dynamic> map) =>
      DarwinEqualizerGetParametersResponse(
        parameters: DarwinEqualizerParametersMessage.fromMap(
            map['parameters'] as Map<dynamic, dynamic>),
      );
}

/// Information communicated to the platform implementation when setting the
/// gain for a Darwin equalizer band.
...
/// Information about a Darwin equalizer band to be communicated with the
/// platform implementation.
...
/// Information about the Darwin equalizer parameters to be communicated with
...
/// Information about the Darwin equalizer to be communicated with the platform
/// implementation.
