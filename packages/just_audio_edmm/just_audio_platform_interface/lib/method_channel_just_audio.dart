...
class MethodChannelAudioPlayer extends AudioPlayerPlatform {
  ...
  Stream<AudioSpectrumEventMessage> get audioSpectrumEventMessageStream =>
      EventChannel('com.ryanheise.just_audio.spectrum.$id')
          .receiveBroadcastStream()
          .cast<Map<dynamic, dynamic>>()
          .map(AudioSpectrumEventMessage.fromMap);
  ...
  Future<DarwinEqualizerGetParametersResponse> darwinEqualizerGetParameters(
    ...
    return DarwinEqualizerGetParametersResponse.fromMap(
        (await _channel.invokeMethod<Map<dynamic, dynamic>>(
            'darwinEqualizerGetParameters', request.toMap()))!);
  }
