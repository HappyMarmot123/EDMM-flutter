...
void main() {
  test('fetchCatalog hits unified endpoint and parses', () async {
    ...
    final tracks = await svc.fetchCatalog(category: CloudinaryCategory.pop, query: 'beat');
  ...
  test('fetchCatalog includes category/query/resourceType in query string', () async {
    late Uri seen;
    final svc = TrackApiService(
      MockClient((req) async {
        seen = req.url;
